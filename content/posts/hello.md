...
<h1 id="about" class="title" style="margin-bottom:0px;"><i class="fa-solid fa-circle-info"> 關於我</h1></i>
...
<div class="profile-pic-wrapper">
    ...
    <div class="profile-text">
        ...
        <div><p style="font-size:14px; margin-left:-30px;  padding-left: 1.8em; text-indent: -1.3em;">※ 歡迎來到我的個人網頁！本網頁旨在提供更具深度與動態感的成果展示；基於資安考量，網頁內容已隱去具體之個人敏感資訊。</p><p style="font-size:14px; margin-left:-30px;  padding-left: 1.8em; text-indent: -1.3em;  margin-top:-20px;">※ 關於更詳細的<strong>個人資料與成績證明</strong>，已整理於郵件附件中。若有任何疑問或建議，歡迎隨時與我聯繫，謝謝您。</p></div>
        </div>
    </div>
</div>
</div>
...
<div class="skill-item">
                <div class="skill-tag">
                    ...
                    <div class="skill-info">
                        ...
                        <span class="skill-desc">大學課程修習 含語法與實作</span>
                    </div>
                </div>
            </div>
        </li>
...
<li>
            <strong class="skill-class"><i class="fa-solid fa-globe"></i> 網頁技術 [基礎]：</strong><br>
...
<div class="skill-item">
                <div class="skill-tag">
                    ...
                    <div class="skill-info">
                        ...
                        <span class="skill-desc">自學 個人網頁實作</span>
                    </div>
                </div>
            </div>
            <div class="skill-item">
                <div class="skill-tag">
                    ...
                    <div class="skill-info">
                        ...
                        <span class="skill-desc">處理樣式與佈局</span>
                    </div>
                </div>
            </div>
        </li>
<li>
           <strong class="skill-class"><i class="fa-solid fa-briefcase "></i> 辦公軟體 [實務]：</strong><br>
 ...
 <div class="skill-item">
                <div class="skill-tag" style="cursor: pointer;" onclick="location.href='#display'">
                    ...
                    <div class="skill-info">
                        ...
                        <span class="skill-desc">公式邏輯處理流程<br>點擊查看實作➔</span>
                    </div>
                </div>
            </div>
...
<div class="skill-item">
                <div class="skill-tag">
                    <i class="fa-solid fa-file-word skill-icon"></i> 
                    <div class="skill-info">
                        <span class="skill-name">Word</span>
                        <span class="skill-desc">報告排版與 SOP 編撰</span>
                    </div>
                </div>
            </div>
...
<div class="skill-item">
                <div class="skill-tag">
                    <i class="fa-solid fa-file-powerpoint skill-icon"></i> 
                    <div class="skill-info">
                        <span class="skill-name">PowerPoint</span>
                        <span class="skill-desc">運用動態轉場 呈現視覺流暢感</span>
                    </div>
                </div>
            </div>
        </li>
...
<div class="section-container">
<h1 id="experience" class="title"><i class="fa-solid fa-briefcase"> 工作經歷</h1></i> 
<div class="custom-section">
<div class="exp-part">   
<div class="exp-card first-card">
        <div class="exp-dot" style="opacity: 0;"></div>
        <div class="exp-content">
        <strong style="font-size:20px;">2019-2022</strong>
        <h4 style="margin: 5px 0;font-size:18px;">大眾運輸公司 會館 </h4>
        <h4 style="margin: 5px 0; font-size:16px;">
        工讀生</h4>
        <div class="exp-text">
        <p style="font-size: 16px;"><strong>職責範疇：</strong><br>負責導覽及櫃檯服務。</p>
        <p style="font-size: 16px;"><strong>學習實踐：</strong><br>因業務頻繁接觸 Excel，除大學選修課程外亦透過網路自主學習，將所學初步應用於日常業務，為日後處理複雜邏輯奠定基礎。</p>
        </div></div>
    </div>
...
<div class="exp-card">
        ...
        <h4 style="margin: 5px 0; font-size:16px;">工讀生➨督導</h4>
        <div class="exp-text">
        <p style="font-size: 16px;"><strong>職位晉升：</strong><br>
        於承攬廠商更迭後留任，並於後續憑藉對業務的熟悉度與實務處理經驗，獲提拔晉升至督導。</p>
        <p style="font-size: 16px;"><strong>職責範疇：</strong><br>
        負責人力調度、排班管理與教育訓練。</p>
...
<div class="exp-card">
        ...
        <h4 style="margin: 5px 0; font-size:18px;">北部大學 計畫辦公室</h4>
        <h4 style="margin: 5px 0; font-size:16px;">專任助理</h4>
        <div class="exp-text">
        <p style="font-size: 16px;"><strong>職責範疇：</strong><br>負責計畫審核、執行及核銷業務。</p>
        <p style="font-size: 16px;"><strong>核心成就：</strong><br>運用 Excel 公式建構分類與時效判斷邏輯，設計<a href="#display" style=" font-weight: bold; color: var(--accent);">「整合式申請表」</a> 。此舉將傳統人工核對轉為邏輯判定，大幅降低審核端之人為誤差，並有效優化跨年度審查的行政效率。</p>
                 </div></div>
</div></div></div>
...
<li style="margin-top:20px;">● 管理實務（流程標準化）： 在第一份工作期間，我因熟悉業務並具備實務處理經驗獲留任並晉升督導。除了負責人力調度，我進一步將經驗整理為 SOP 作業手冊，這除了輔助教育訓練過程，也讓團隊的行政流程更具穩定性。</li>
...
由於申請資料包含長達 10 年的歷程（後續改為5年），過去使用紙本填寫缺乏連續性，導致申請人易誤填資料，審查端也必須耗費大量時間逐筆翻閱舊檔核對。為了優化這類重複性庶務，我設計了 Excel 申請表，將零散紀錄整合化，實現資料自動勾稽並提升審核準確度。</p>
<div class="comparison-container" >
  <div class="comparison-header">
    <div class="comp-card legacy">
    <div style="display:flex; flex-direction: column; align-items: center;">
      <div class="comp-tag">PAST: 傳統紙本</div>
      <div class="comp-content">
        <p><i class="fa-solid fa-x"></i> 每年重複填寫，資料斷裂難追蹤</p>
        <p><i class="fa-solid fa-x"></i> 人工核對舊檔，重複審查耗時</p>
        <p><i class="fa-solid fa-x"></i> 效期手動計算，繁雜且易出錯</p>
      </div>
    </div></div>
...
<div style="display:flex; flex-direction: column; align-items: center;">
      <div class="comp-tag primary">NOW: 整合優化</div>
      <div class="comp-content primary-content">
        <p>  <i class="fa-solid fa-v"></i> <strong>歷程收錄</strong>：一次填寫，長期存查</p>
        <p>  <i class="fa-solid fa-v"></i> <strong>歷程維護</strong>：僅需審查當年度增量</p>
        <p>  <i class="fa-solid fa-v"></i> <strong>時效判定</strong>：自動篩選與點數彙整</p>
      </div>
    </div>
  </div> </div>
...
<div class="step-box" id="step3">
  ...
  <div class="excel-frame-container" id="excelContainer">
    <div class="excel-loading-overlay" id="excelOverlay">
      <div class="unlock-text">點擊 操作申請表</div>
    </div>
...
</div><div style="text-align: right; margin: 10px 0; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;">
    <a href="https://1drv.ms/x/c/73b1cde18a4d20c7/IQTQCJOX71ueSbGBbXcylEGmAf-oAclUp9hFzVi38szUVeE?em=2&wdAllowInteractivity=False&AllowTyping=True&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True" 
       target="_blank" 
       rel="noopener noreferrer" 
       style="display: inline-block; background-color: var(--foreground); color: white; padding: 8px 10px; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 14px; box-shadow: 3px 3px 2px rgba(81, 51, 25, 0.2); transition: background-color 0.3s;">
       全螢幕操作
    </a>
</div></div></div>
<div class="accordion">
...
本專題源於大學時期打工的實際觀察。當時發現職場在薪資計算、出勤打卡與資訊傳遞（公告）上存在效率低落與溝通斷層的問題，因此以整合雇主與員工需求的行動應用程式作為專題主題。</p>
      <p class="indentation">※ 因為主要負責 UI 佈局及功能設計，加上專案開發時間較久遠，故僅展示部分開發紀錄與部分介面原始碼。</p>
      <div class="carousel">
...
<div class="accordion-header dark" onclick="this.parentElement.classList.toggle('active')">
  ...
  <div class="accordion-content" style="background: #826f5a;">
    <div class="glass-body" style="color: #ffffff; padding:20px 10px;">
  <div style="display: grid; grid-template-columns: 1fr; gap: 15px;">
    
  <div>
      <strong style="display: block; font-size: 16px; margin-bottom: 5px;"><i class="fa-solid fa-thumbtack"></i> 定位方式</strong>
      <p style="margin: 0; font-size: 14px; opacity: 0.8;">採用「底部吸附」設計，確保發布按鈕不被遮擋。</p>
    </div>

  <hr style="border: 0; border-top: 1px solid rgba(109, 93, 75, 0.1); margin: 0;">

  <div>
      <strong style="display: block; font-size: 16px; margin-bottom: 5px;"><i class="fa-solid fa-hand-sparkles"></i> 互動體驗</strong>
