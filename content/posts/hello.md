...
<div style="display:flex; flex-direction: column; align-items: center;">
      ...
      <div class="comp-content primary-content">
        <p>  <i class="fa-solid fa-v"></i> <strong>歷程資料收錄</strong>：一次填寫，長期存查</p>
        <p>  <i class="fa-solid fa-v"></i> <strong>歷史狀態維護</strong>：僅需審查當年度增量</p>
        <p>  <i class="fa-solid fa-v"></i> <strong>時效規則判定</strong>：自動篩選與點數彙整</p>
      </div>
    </div>
  </div> </div>
...
<p style="margin-top:20px; margin-bottom:0px; padding-bottom:0px; font-size:14px; padding-left: 2.2em; text-indent: -1.2em; ">※ 本表單僅供功能演示，已移除部分資訊及功能。</p><p style="font-size:14px; margin:0; padding-left: 2.2em; text-indent: -1.2em; ">※ 建議使用電腦操作。非電腦用戶務必先行填寫「當年度」以喚起鍵盤；如顯示錯誤，請更新頁面。</p><p style="font-size:14px; margin:0; padding-left: 2.2em; text-indent: -1.2em; ">※ 申請表補充：</p><p style="font-size:14px; margin:0; padding-left: 3.5em; text-indent: -1.2em; ">1. 此表設定每筆適用年限為5年，每2點為一基數，其作為核發金額基準。</p><p style="font-size:14px; margin:0; padding-left: 3.5em; text-indent: -1.2em; margin-bottom:30px;">2. 點擊「點此移至空白欄位填寫」可跳至空白欄位做填寫。</p>
...
本專題源於大學時期打工的實際觀察。當時發現職場在薪資計算、出勤打卡與資訊傳遞（公告）上存在效率低落與溝通斷層的問題，因此以整合雇主與員工需求的行動應用程式作為專題主題。</p>
      <p style="font-size:14px; margin:0 0 20px 0; padding:0 15px; text-align: left;padding-left: 2.2em; text-indent: -1.2em; ">※ 因為主要負責 UI 佈局及功能設計，加上專案開發時間較久遠，故僅展示部分開發紀錄與部分介面原始碼。</p>
      <div class="carousel">
